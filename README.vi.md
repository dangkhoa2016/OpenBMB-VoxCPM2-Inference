...
CI thông thường M0 đến M11 vẫn GPU-free và model-free. M0 từ chối tracked `.bin` cùng các định dạng model-weight. Xem [`docs/API-RUNTIME.vi.md`](docs/API-RUNTIME.vi.md) cho HTTP contract và [`docs/T4X2-TWO-WORKER-RUNTIME.vi.md`](docs/T4X2-TWO-WORKER-RUNTIME.vi.md) cho ranh giới M10 T4x2 đã đo.
